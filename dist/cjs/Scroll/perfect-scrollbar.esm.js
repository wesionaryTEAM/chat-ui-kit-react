...
var PerfectScrollbar = function PerfectScrollbar(element, userSettings) {
  ...
  this.railBorderXWidth =
    toInt(railXStyle.borderLeftWidth) + toInt(railXStyle.borderRightWidth); // Set rail to display:block to calculate margins
...
PerfectScrollbar.prototype.update = function update() {
  ...
  this.railYMarginHeight =
    ...
    toInt(get(this.scrollbarYRail).marginBottom); // Hide scrollbars not to affect scrollWidth and scrollHeight
